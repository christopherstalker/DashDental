...
export async function refreshConversationProjection(conversationId: string) {
  ...
  try {
    ...
    return buildConversationProjectionFromState(state, conversationId);
  }
}
...
export async function refreshLeadConversationProjections(leadId: string) {
  ...
  try {
    ...
    return listConversationProjectionsFromState(state, lead.organizationId).filter(
      (projection) => projection.leadId === leadId,
    );
  }
}
...
export async function refreshOrganizationConversationProjections(
  ...
  try {
    ...
    return listConversationProjectionsFromState(await readAppState(), organizationId);
  }
}
...
export async function listInboxConversationProjections(input: {
  ...
  const listFromState = (state: AppState) =>
  ...
  if (input.state) {
    return listFromState(input.state);
  }
  ...
  return listFromState(await readAppState());
}
