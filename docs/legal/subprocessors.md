...
| Online billing | Paddle or Stripe, when enabled | Checkout, Portal, subscription webhooks | Customer id, plan, invoice/payment status | Use only after provider setup, webhook verification, and staging rehearsal |
