...
export const authRoutes: AppRouteDefinition[] = [
  {
    ...
    href: "/login",
    label: "Sign in",
    description: "Email/password and SSO entrypoint before choosing a clinic workspace.",
    layout: "auth",
    group: "Access",
  ...
  },
  {
    ...
    description: "Owner account creation and clinic workspace provisioning.",
    layout: "auth",
    group: "Access",
    requiredRole: "manager",
    pageKind: "page",
...
export const workspaceRoutes: AppRouteDefinition[] = [
  ...
  },
  {
    ...
    href: "/reviews",
    label: "Reviews",
    description: "Review requests and recall reminders for booked or missed patients.",
    layout: "workspace",
    group: "Optimize",
    requiredRole: "manager",
    pageKind: "page",
  ...
  },
  {
    ...
    href: "/locations",
    label: "Locations",
    description: "Owner rollup across multiple clinic workspaces and revenue exceptions.",
    layout: "workspace",
    group: "Govern",
    requiredRole: "owner",
    pageKind: "page",
...
export const publicRoutes: AppRouteDefinition[] = [
  ...
  },
  {
    ...
    href: "/qa",
    label: "Q&A",
    description: "Public buyer questions covering launch, billing, integrations, and security.",
    layout: "public",
    group: "Marketing",
    requiredRole: "manager",
    pageKind: "page",
  },
  {
    ...
    href: "/trust",
    label: "Trust center",
    description: "Security, privacy, billing lock, AI boundaries, and policy links.",
    layout: "public",
    group: "Marketing",
    requiredRole: "manager",
    pageKind: "page",
  ...
  },
  {
    ...
    href: "/case-study",
    label: "Case study",
    description: "Beta clinic before-and-after operating metrics.",
    layout: "public",
    group: "Marketing",
    requiredRole: "manager",
    pageKind: "page",
  },
  {
    ...
    href: "/trial",
    label: "Launch",
    description: "Public explanation of the guided launch and activation flow.",
    layout: "public",
    group: "Marketing",
    requiredRole: "manager",
    pageKind: "page",
